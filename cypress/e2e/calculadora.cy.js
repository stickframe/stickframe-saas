describe('Fluxo Crítico: Calculadora Pública', () => {
  it('Deve preencher a simulação e gerar um lead com sucesso', () => {
    // 1. Acessa a página da calculadora
    cy.visit('/calcular');
    cy.contains('Calcule o custo da sua obra').should('be.visible');
    ...
    cy.contains('Sua estimativa está pronta!').should('be.visible');
    ...
    cy.contains('Recebemos seu contato!').should('be.visible');

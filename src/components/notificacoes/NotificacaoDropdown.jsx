    ...
    <div style={{ position: "relative" }}>
      ...
      {aberto && (
        <>
          ...
          <div style={{ position: "absolute", top: "calc(100% + 8px)", left: 0, width: 360, background: C.surface, border: `1px solid ${C.border}`, borderRadius: 12, zIndex: 99, boxShadow: "0 8px 32px #00000022", overflow: "hidden" }}>

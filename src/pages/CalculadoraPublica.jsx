...
// ─── Kit data ─────────────────────────────────────────────────────────────────
const INSUMOS_KIT = [
  { categoria: "Estrutura de Aço",      nome: "Montante C 90×40×15×1,25mm",         un: "pç",  base: 1.50,  preco: 62.00 },
  { categoria: "Estrutura de Aço",      nome: "Guia U 92×40×1,25mm",                un: "m",   base: 1.10,  preco: 19.00 },
  { categoria: "Estrutura de Aço",      nome: "Montante C 140×40×15×1,25mm",        un: "pç",  base: 0.30,  preco: 170.00 },
  { categoria: "Fechamento",            nome: "Chapa OSB 11,1mm (1,22×2,44)",       un: "chp", base: 0.38,  preco: 85.00 },
  { categoria: "Fechamento",            nome: "Placa de Gesso ST 13mm (1,20×2,40)", un: "chp", base: 0.85,  preco: 42.00 },
  { categoria: "Fechamento",            nome: "Placa Cimentícia 10mm (1,20×2,40)",  un: "chp", base: 0.18,  preco: 118.00 },
  { categoria: "Isolamento",            nome: "Lã de Vidro 50mm",                   un: "m²",  base: 1.30,  preco: 27.00 },
  { categoria: "Isolamento",            nome: "Impermeabilizante flexível",          un: "m²",  base: 0.15,  preco: 42.00 },
  { categoria: "Fixação",               nome: "Parafuso TEX 4,2×16mm (flangeado)",  un: "cx",  base: 0.40,  preco: 55.00 },
  { categoria: "Fixação",               nome: "Parafuso TEX 4,2×38mm",              un: "cx",  base: 0.80,  preco: 60.00 },
  { categoria: "Fundação (Radier)",     nome: "Concreto C-25",                      un: "m³",  base: 0.10,  preco: 490.0, fund: true },
  { categoria: "Fundação (Radier)",     nome: "Ferragem CA-50 ⌀6,3mm",              un: "kg",  base: 6.00,  preco:  8.50, fund: true },
  { categoria: "Fundação (Radier)",     nome: "Tela soldada Q-92 (3×2m)",           un: "pç",  base: 0.17,  preco: 78.00, fund: true },
  { categoria: "Cobertura",             nome: "Telha shingle (fardo 3m²)",          un: "fd",  base: 0.38,  preco: 210.0 },
  { categoria: "Cobertura",             nome: "Manta subcobertura 1,5m",            un: "m²",  base: 1.05,  preco: 12.00 },
  { categoria: "Cobertura",             nome: "Calha PVC 150mm",                    un: "m",   base: 0.30,  preco: 32.00 },
  { categoria: "Esquadrias",            nome: "Janela alumínio c/ vidro (1,20×1,20)",un:"un",  base: 0.055, preco: 780.0 },
  { categoria: "Esquadrias",            nome: "Porta interna 0,80×2,10",            un: "un",  base: 0.08,  preco: 480.0 },
  { categoria: "Instalações Elétricas", nome: "Conduíte + fios + caixas",           un: "m²",  base: 1.00,  preco: 75.00 },
  { categoria: "Inst. Hidrossanitárias",nome: "Tubulação PVC água fria/quente",     un: "m²",  base: 1.00,  preco: 68.00 },
  { categoria: "Acabamentos",           nome: "Piso vinílico click 4mm",            un: "m²",  base: 0.90,  preco: 65.00 },
  { categoria: "Acabamentos",           nome: "Massa corrida + pintura látex",      un: "m²",  base: 2.80,  preco: 12.00 },
  { categoria: "Acabamentos",           nome: "Forro drywall ST (teto)",            un: "m²",  base: 0.90,  preco: 48.00 },
  { categoria: "Projetos e Engenharia", nome: "Projeto Arquitetônico",              un: "m²",  base: 1.00,  preco: 55.00 },
  { categoria: "Projetos e Engenharia", nome: "Projeto Estrutural LSF",             un: "m²",  base: 1.00,  preco: 18.00 },
  { categoria: "Mão de Obra",           nome: "Montagem estrutura LSF",             un: "m²",  base: 1.00,  preco: 450.00 },
  { categoria: "Mão de Obra",           nome: "Instalação vedações (OSB/gesso/cim)",un: "m²",  base: 1.00,  preco: 220.00 },
  { categoria: "Mão de Obra",           nome: "Cobertura (telha shingle)",          un: "m²",  base: 1.00,  preco: 320.00 },
];

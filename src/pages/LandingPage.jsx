      ...
      <section className="lp-hero">
        ...
        <div className="lp-wrap">
          <div className="lp-hero-in">
            ...
            <h1>O ERP feito para<br /><em>construção</em><br />industrializada</h1>
            <p className="h-sub">
              O sistema que sua construtora de Steel Frame precisa. Orçamento, obra, financeiro e equipe numa só plataforma — na velocidade da construção a seco. Do primeiro lead à entrega da chave.
            </p>
            <div className="h-cta">
              <a href="/cadastro" className="btn btn-white btn-lg">Solicitar demonstração</a>
              <a href="/calcular" className="btn btn-outline-w btn-lg">Ver funcionalidades</a>
            </div>

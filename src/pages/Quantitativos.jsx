...
const TEMPLATES = {
  ...
  "Fundação": [
    ...
    { categoria: "Fundação", descricao: "Mão de obra fundação",          unidade: "m²", quantidade: 1,    custo_unitario: 100   },
  ],
  "Estrutura Steel Frame": [
    { categoria: "Estrutura", descricao: "Frame em aço engenheirado (material)", unidade: "kg", quantidade: 27,   custo_unitario: 8     },
    { categoria: "Estrutura", descricao: "M.O. montagem estrutura engenheirada", unidade: "kg", quantidade: 27,   custo_unitario: 4     },
    { categoria: "Estrutura", descricao: "M.O. montagem estrutura stick",        unidade: "kg", quantidade: 0,    custo_unitario: 8     },
  ...
  "Fechamentos": [
    { categoria: "Vedação", descricao: "OSB 11,1 mm (material)",                unidade: "m²", quantidade: 1.1,  custo_unitario: 35    },
    { categoria: "Vedação", descricao: "M.O. aplicação OSB 11,1 mm",            unidade: "m²", quantidade: 1.1,  custo_unitario: 20    },
    { categoria: "Vedação", descricao: "Manta hidrófuga (Tyvek)",               unidade: "m²", quantidade: 1.1,  custo_unitario: 8     },
    { categoria: "Vedação", descricao: "M.O. aplicação Manta Tyvek",            unidade: "m²", quantidade: 1.1,  custo_unitario: 2     },
    { categoria: "Vedação", descricao: "Placa GlasrocX (material)",             unidade: "m²", quantidade: 1.05, custo_unitario: 35    },
    { categoria: "Vedação", descricao: "M.O. aplicação GlasrocX",               unidade: "m²", quantidade: 1.05, custo_unitario: 20    },
    { categoria: "Vedação", descricao: "Basecoat sistema completo (material)",  unidade: "m²", quantidade: 1,    custo_unitario: 55    },
    { categoria: "Vedação", descricao: "M.O. aplicação Basecoat",               unidade: "m²", quantidade: 1,    custo_unitario: 45    },
    { categoria: "Vedação", descricao: "Gesso acartonado Performa (material)",  unidade: "m²", quantidade: 1.05, custo_unitario: 35    },
    { categoria: "Vedação", descricao: "M.O. aplicação Gesso Performa",         unidade: "m²", quantidade: 1.05, custo_unitario: 20    },
    { categoria: "Vedação", descricao: "GlasrocX áreas molhadas (material)",    unidade: "m²", quantidade: 1.05, custo_unitario: 35    },
    { categoria: "Vedação", descricao: "M.O. GlasrocX áreas molhadas",          unidade: "m²", quantidade: 1.05, custo_unitario: 20    },
    { categoria: "Vedação", descricao: "Isolamento térmico/ac. paredes (mat.)", unidade: "m²", quantidade: 1,    custo_unitario: 8     },
    { categoria: "Vedação", descricao: "M.O. aplicação isolamento paredes",     unidade: "m²", quantidade: 1,    custo_unitario: 4     },
    { categoria: "Vedação", descricao: "Isolamento térmico/ac. forro (mat.)",   unidade: "m²", quantidade: 1,    custo_unitario: 10    },
    { categoria: "Vedação", descricao: "M.O. aplicação isolamento forro",       unidade: "m²", quantidade: 1,    custo_unitario: 4     },
  ],
  "Cobertura": [
    { categoria: "Cobertura", descricao: "Telha cerâmica (material)",           unidade: "m²", quantidade: 1.3,  custo_unitario: 60    },
    { categoria: "Cobertura", descricao: "M.O. cobertura telhado",              unidade: "m²", quantidade: 1.3,  custo_unitario: 10    },
    { categoria: "Cobertura", descricao: "Telha sanduíche termoacústica (mat.)", unidade: "m²", quantidade: 1.3, custo_unitario: 45   },
    { categoria: "Cobertura", descricao: "M.O. cobertura telha sanduíche",      unidade: "m²", quantidade: 1.3,  custo_unitario: 10    },
    { categoria: "Cobertura", descricao: "Forro beiral GlasrocX (material)",    unidade: "m²", quantidade: 1,    custo_unitario: 35    },
    { categoria: "Cobertura", descricao: "M.O. forro beiral GlasrocX",          unidade: "m²", quantidade: 1,    custo_unitario: 35    },
    { categoria: "Cobertura", descricao: "Basecoat forro beiral (material)",    unidade: "m²", quantidade: 1,    custo_unitario: 55    },
    { categoria: "Cobertura", descricao: "M.O. Basecoat forro beiral",          unidade: "m²", quantidade: 1,    custo_unitario: 45    },
    { categoria: "Cobertura", descricao: "OSB subcobertura 11,1 mm (material)", unidade: "m²", quantidade: 1.1,  custo_unitario: 35    },
    { categoria: "Cobertura", descricao: "M.O. aplicação OSB subcobertura",     unidade: "m²", quantidade: 1.1,  custo_unitario: 25    },
  ],
  "Instalações": [
    { categoria: "Instalações", descricao: "Elétrica — infraestrutura (mat.)",  unidade: "m²", quantidade: 1,    custo_unitario: 120   },
    { categoria: "Instalações", descricao: "Hidráulica — infraestrutura (mat.)", unidade: "m²", quantidade: 1,   custo_unitario: 120   },
    { categoria: "Instalações", descricao: "Impermeabilização laje seca (mat.)", unidade: "m²", quantidade: 1,   custo_unitario: 15    },
    { categoria: "Instalações", descricao: "M.O. impermeabilização laje seca",  unidade: "m²", quantidade: 1,    custo_unitario: 15    },
    { categoria: "Instalações", descricao: "Laje impermeabilizada manta asfált. (mat.)", unidade: "m²", quantidade: 1, custo_unitario: 0 },
    { categoria: "Instalações", descricao: "M.O. manta asfáltica",              unidade: "m²", quantidade: 1,    custo_unitario: 15    },
    { categoria: "Instalações", descricao: "Quadro de distribuição",            unidade: "un", quantidade: 1,    custo_unitario: 680   },
  ],
  "Acabamento": [

...
const TEMPLATES = {
  ...
  "Estrutura Steel Frame": [
    { categoria: "Estrutura", descricao: "Frame em aço engenheirado",    unidade: "kg", quantidade: 27,   custo_unitario: 8     },
  ...
  "Fechamentos": [
    { categoria: "Vedação", descricao: "OSB 11,1 mm (externo)",          unidade: "m²", quantidade: 1.1,  custo_unitario: 35    },
    { categoria: "Vedação", descricao: "Manta hidrófuga (Tyvek)",        unidade: "m²", quantidade: 1.1,  custo_unitario: 8     },
    { categoria: "Vedação", descricao: "Placa cimentícia (externo)",     unidade: "m²", quantidade: 1.05, custo_unitario: 45    },
    { categoria: "Vedação", descricao: "Placa GlasrocX",                 unidade: "m²", quantidade: 1.05, custo_unitario: 35    },
    { categoria: "Vedação", descricao: "Basecoat sistema completo",      unidade: "m²", quantidade: 1,    custo_unitario: 55    },
    { categoria: "Vedação", descricao: "Gesso acartonado ST (interno)",  unidade: "m²", quantidade: 1.05, custo_unitario: 35    },
    { categoria: "Vedação", descricao: "Gesso acartonado (forro)",       unidade: "m²", quantidade: 1,    custo_unitario: 40    },
    { categoria: "Vedação", descricao: "Isolamento térmico/ac. paredes", unidade: "m²", quantidade: 1,    custo_unitario: 8     },
    { categoria: "Vedação", descricao: "Isolamento térmico/ac. forro",   unidade: "m²", quantidade: 1,    custo_unitario: 10    },
    { categoria: "Vedação", descricao: "Mão de obra fechamento",         unidade: "m²", quantidade: 1,    custo_unitario: 75    },
  ],
  "Cobertura": [
    { categoria: "Cobertura", descricao: "Telha cerâmica",               unidade: "m²", quantidade: 1.3,  custo_unitario: 60    },
    { categoria: "Cobertura", descricao: "Telha trapezoidal termoacústica", unidade: "m²", quantidade: 1.3, custo_unitario: 45  },
    { categoria: "Cobertura", descricao: "Estrutura forro beiral",       unidade: "m²", quantidade: 1,    custo_unitario: 15    },
    { categoria: "Cobertura", descricao: "Forro beiral GlasrocX",        unidade: "m²", quantidade: 1,    custo_unitario: 35    },
    { categoria: "Cobertura", descricao: "Mão de obra cobertura",        unidade: "m²", quantidade: 1,    custo_unitario: 80    },
  ],
  "Instalações": [
    { categoria: "Instalações", descricao: "Elétrica (infraestrutura)",  unidade: "m²", quantidade: 1,    custo_unitario: 120   },
    { categoria: "Instalações", descricao: "Hidráulica (infraestrutura)", unidade: "m²", quantidade: 1,   custo_unitario: 120   },
    { categoria: "Instalações", descricao: "Impermeabilização laje seca", unidade: "m²", quantidade: 1,   custo_unitario: 15    },

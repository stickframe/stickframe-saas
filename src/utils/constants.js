...
export const PERFIS = {
  ...
  engenheiro: {
    label: "Engenheiro",
    cor: C.steel,
    paginas: ["dashboard","obras","cronograma","medicoes","diario","vistorias","bim","stickfem","quantitativos","fornecedores","monitor_precos","calculadora","orcamento_tecnico","orcamento_sf","equipamentos","checklists","equipe","equipe_sf","sst","suprimentos","historico","stickbrain","inteligencia","configuracoes","biblioteca","benchmarks","cursos"],
  },
  financeiro: {
    label: "Financeiro",
    cor: C.success,

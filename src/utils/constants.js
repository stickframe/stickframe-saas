...
// ─── NAV ─────────────────────────────────────────────────────────────────────
export const NAV = [
  { key: "dashboard",         label: "Dashboard",            icon: "LayoutDashboard", grupo: null },
  ...
  { key: "cronograma",        label: "Cronograma",           icon: "BarChart2",       grupo: "Obras" },
  { key: "medicoes",          label: "Medições de Obra",     icon: "Ruler",           grupo: "Obras" },
  { key: "diario",            label: "Diário de Obra",       icon: "BookOpen",        grupo: "Obras" },
  { key: "vistorias",         label: "Vistorias & FVS",      icon: "ClipboardCheck",  grupo: "Obras" },
  ...
  { key: "bi",                label: "BI",                   icon: "BarChart2",       grupo: "Gestão", badge: "PRO", perfis: ["diretor"] },
  { key: "inteligencia",      label: "IA da Obra",           icon: "Brain",           grupo: "Gestão", badge: "IA",  perfis: ["diretor", "engenheiro"] },

...
export const NAV = [
  ...
  { key: "equipe",            label: "StickTeam™",           icon: "HardHat",         grupo: "Obras" },
  { key: "sst",               label: "SST",                  icon: "ShieldAlert",     grupo: "Obras" },
  { key: "financeiro",        label: "StickCash™",           icon: "DollarSign",      grupo: "Financeiro" },
  ...
  { key: "suprimentos",       label: "StickSupply™",         icon: "PackageOpen",     grupo: "Compras" },
  ...
  { key: "bi",                label: "StickPulse™",          icon: "BarChart2",       grupo: "Gestão", badge: "PRO", perfis: ["diretor"] },
  { key: "inteligencia",      label: "StickBrain™",          icon: "Brain",           grupo: "Gestão", badge: "IA",  perfis: ["diretor", "engenheiro"] },

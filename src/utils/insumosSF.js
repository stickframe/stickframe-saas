...
export const SISTEMAS_SF = [
    ...
    opcoes: [
      {
        ...
        itens: [
          { nome: "Montante C 90×40×15×0,90mm",         un: "pç", base: 1.50, preco: 19,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "Guia U 92×40×0,90mm",                un: "m",  base: 1.10, preco: 12,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "Montante C 90×40×15×0,90mm (verga)", un: "pç", base: 0.30, preco: 19,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          ...
          { nome: "OSB 11,1mm (1,22×2,44m) — contraventamento", un: "chp", base: 0.38, preco: 85, grupo: "Estrutura", categoria: "Estrutura de Aço" },
        ],
      },
      {
        ...
        aplicaFatorPadrao: true,
        itens: [
          { nome: "Montante C 90×40×15×1,25mm",         un: "pç", base: 1.50, preco: 26,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "Guia U 92×40×1,25mm",                un: "m",  base: 1.10, preco: 16,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "Montante C 90×40×15×1,25mm (verga)", un: "pç", base: 0.30, preco: 26,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "Chapa de reforço (steel plate 90mm)", un: "pç", base: 0.20, preco: 12,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "Prego helicóptero — track fix",       un: "kg", base: 0.25, preco: 32,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "Fita de vedação de guia (EPDM 50mm)", un: "m",  base: 1.20, preco: 5.20, grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "OSB 11,1mm (1,22×2,44m) — contraventamento", un: "chp", base: 0.38, preco: 85, grupo: "Estrutura", categoria: "Estrutura de Aço" },
      ...
      },
      {
        ...
        aplicaFatorPadrao: true,
        itens: [
          { nome: "Montante C 90×40×15×1,50mm",         un: "pç", base: 1.50, preco: 32,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "Guia U 92×40×1,50mm",                un: "m",  base: 1.10, preco: 20,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "Montante C 90×40×15×1,50mm (verga)", un: "pç", base: 0.30, preco: 32,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
      ...
      },
      {
        ...
        aplicaFatorPadrao: true,
        itens: [
          { nome: "Montante C 150×40×15×1,25mm",        un: "pç", base: 1.40, preco: 36,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "Guia U 152×40×1,25mm",               un: "m",  base: 1.10, preco: 23,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "Montante C 150×40×15×1,25mm (verga)", un: "pç", base: 0.25, preco: 36,  grupo: "Estrutura", categoria: "Estrutura de Aço" },
          ...
          { nome: "OSB 11,1mm (1,22×2,44m) — contraventamento", un: "chp", base: 0.40, preco: 85, grupo: "Estrutura", categoria: "Estrutura de Aço" },
        ],
      },
      {
        ...
        aplicaFatorPadrao: true,
        itens: [
          { nome: "Montante C 200×65×15×1,50mm",        un: "pç", base: 1.30, preco: 62,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "Guia U 202×65×1,50mm",               un: "m",  base: 1.10, preco: 39,   grupo: "Estrutura", categoria: "Estrutura de Aço" },
          { nome: "Montante C 200×65×15×1,50mm (verga)", un: "pç", base: 0.20, preco: 62,  grupo: "Estrutura", categoria: "Estrutura de Aço" },
          ...
          { nome: "OSB 15mm (1,22×2,44m) — contraventamento", un: "chp", base: 0.40, preco: 98, grupo: "Estrutura", categoria: "Estrutura de Aço" },
        ],
      },
    ],
  },
    ...
    opcoes: [
      {
        ...
        aplicaFatorPadrao: true,
        itens: [
          { nome: "Placa cimentícia 10mm (1,20×2,40m)",  un: "chp", base: 0.38, preco: 78,   grupo: "Vedação externa", categoria: "Fechamento" },
      ...
      },
      {
        ...
        aplicaFatorPadrao: true,
        itens: [
          { nome: "Placa cimentícia 12mm (1,20×2,40m)",  un: "chp", base: 0.38, preco: 95,   grupo: "Vedação externa", categoria: "Fechamento" },
    ...
    opcoes: [
      {
        ...
        aplicaFatorPadrao: true,
        itens: [
          { nome: "Placa gesso BA 12,5mm (1,20×2,40m)", un: "chp", base: 0.85, preco: 25,   grupo: "Vedação interna", categoria: "Fechamento" },
          { nome: "Massa para juntas pronta (balde 25kg)", un: "bd", base: 0.04, preco: 98,  grupo: "Vedação interna", categoria: "Fechamento" },
      ...
      },
      {
        ...
        aplicaFatorPadrao: true,
        itens: [
          { nome: "Placa gesso RU 12,5mm (1,20×2,40m)", un: "chp", base: 0.85, preco: 32,   grupo: "Vedação interna", categoria: "Fechamento" },
          { nome: "Massa para juntas pronta (balde 25kg)", un: "bd", base: 0.04, preco: 98,  grupo: "Vedação interna", categoria: "Fechamento" },
          { nome: "Fita de juntas 50mm (rolo 90m)",      un: "rl",  base: 0.02, preco: 58,   grupo: "Vedação interna", categoria: "Fechamento" },
          { nome: "Cantoneira metálica 31×31mm",         un: "m",   base: 0.25, preco: 5.50, grupo: "Vedação interna", categoria: "Fechamento" },
        ],
      },
      {
        ...
        aplicaFatorPadrao: true,
        itens: [
          { nome: "Placa gesso RF 12,5mm (1,20×2,40m)", un: "chp", base: 0.85, preco: 38,   grupo: "Vedação interna", categoria: "Fechamento" },
          { nome: "Massa para juntas pronta (balde 25kg)", un: "bd", base: 0.04, preco: 98,  grupo: "Vedação interna", categoria: "Fechamento" },
          { nome: "Fita de juntas 50mm (rolo 90m)",      un: "rl",  base: 0.02, preco: 58,   grupo: "Vedação interna", categoria: "Fechamento" },
          { nome: "Cantoneira metálica 31×31mm",         un: "m",   base: 0.25, preco: 5.50, grupo: "Vedação interna", categoria: "Fechamento" },
        ],
      },
      {
        ...
        itens: [
          { nome: "Placa gesso BA 12,5mm (1,20×2,40m)", un: "chp", base: 0.85, preco: 25,   grupo: "Vedação interna", categoria: "Fechamento" },
          { nome: "Placa gesso BA 15mm (1,20×2,40m)",   un: "chp", base: 0.85, preco: 30,   grupo: "Vedação interna", categoria: "Fechamento" },
          { nome: "Manta acústica 25mm (m²)",           un: "m²",  base: 1.00, preco: 42,   grupo: "Vedação interna", categoria: "Fechamento" },
          { nome: "Massa para juntas pronta (balde 25kg)", un: "bd", base: 0.06, preco: 98,  grupo: "Vedação interna", categoria: "Fechamento" },
    ...
    opcoes: [
      {
        ...
        aplicaFatorPadrao: true,
        itens: [
          { nome: "Telha shingle asfáltico (m²)",       un: "m²",  base: 1.20, preco: 95,   grupo: "Cobertura", categoria: "Cobertura" },
          { nome: "OSB 11,1mm (base telhado)",          un: "chp", base: 0.40, preco: 85,   grupo: "Cobertura", categoria: "Cobertura" },
  ...
  //  8. FIXAÇÃO GERAL
  {
    ...
    itens: [
      ...
      { nome: "Massa para juntas pronta (balde 25kg)",        un: "bd", base: 0.04, preco: 98,   grupo: "Fixação", categoria: "Fixação" },
  ...
  //  15. LAJE SECA (piso do sobrado)
  {
    ...
    mao_obra_cub: 0.03,
    itens: [
      { nome: "OSB 18mm — base estrutural (1,22×2,44m)", un: "chp", base: 0.36, preco: 115,  grupo: "Laje Seca", categoria: "Estrutura de Aço" },
